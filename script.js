...
function somar() {
  ...
  let primeiro_numero_maior_que = Number(document.getElementById("primeiro_numero_maior_que").value);

  //Captura o que está dentro do segundo input no formulário
  //Number - Transforma o texto capturado em Numero
  let segundo_numero_maior_que = Number(document.getElementById("segundo_numero_maior_que").value);
